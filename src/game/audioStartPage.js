...
class AudioStartPage extends React.Component {
    constructor(props) {
    super(props);
    this.state={
      clickStart: false,
  ...
  startGame(){
    let group = document.getElementById("audioSelectGroup").options.selectedIndex;
    let page = document.getElementById("audioSelectPage").options.selectedIndex;
        ...
        <div className ="container audio-main-container h-100">
          <div className = "row">
            <div className = "audio-btns-setting">
              ...
              <button className="btn btn-close-audio" onClick={this.props.clickTeam}>
                ...
                <div className="card-body">
                  <h5 className="card-title">Настройки игры</h5>
                    <div className="d-flex align-items-center">
                      <select id="audioSelectGroup" className="form-control col-3 mr-3 mb-3">
                    ...
                    <div className="d-flex align-items-center  select-page">
                      <select id="audioSelectPage" className="form-control col-3 mr-3 mb-3" size="2">
